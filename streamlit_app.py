...
def dashboard():
    ...
    link = '[full screen]("http://43.202.45.220:5601/goto/44afe3f5f0b1fe5465f02cbe57188867?security_tenant=private")'
    st.markdown(link, unsafe_allow_html=True)
    
    components.iframe("http://43.202.45.220:5601/goto/44afe3f5f0b1fe5465f02cbe57188867?security_tenant=private", height=4000)
